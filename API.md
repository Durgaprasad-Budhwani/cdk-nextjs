...
###### `props`<sup>Optional</sup> <a name="props" id="tech9-cdk-nextjs-standalone.ImageOptimizationLambda.metricInvocations.parameter.props"></a>
...
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationLambda.metricAllErrors">metricAllErrors</a></code> | Metric for the number of Errors executing all Lambdas. |
...
###### `props`<sup>Optional</sup> <a name="props" id="tech9-cdk-nextjs-standalone.ImageOptimizationLambda.metricAll.parameter.props"></a>
...
- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsProps">NextjsProps</a>
...
| <code><a href="#tech9-cdk-nextjs-standalone.Nextjs.property.serverFunction">serverFunction</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextJsLambda">NextJsLambda</a></code> | The main NextJS server handler lambda function. |
...
##### `id`<sup>Required</sup> <a name="id" id="tech9-cdk-nextjs-standalone.NextJsLambda.Initializer.parameter.id"></a>
...
#### Initializers <a name="Initializers" id="tech9-cdk-nextjs-standalone.NextjsLayer.Initializer"></a>
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.environmentOutputs">environmentOutputs</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.path">path</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.stack">stack</a></code> | <code>string</code> | *No description.* |

---

##### `environmentOutputs`<sup>Required</sup> <a name="environmentOutputs" id="tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.environmentOutputs"></a>
...
##### `path`<sup>Required</sup> <a name="path" id="tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.path"></a>
...
##### `stack`<sup>Required</sup> <a name="stack" id="tech9-cdk-nextjs-standalone.BaseSiteEnvironmentOutputsInfo.property.stack"></a>
...
### BaseSiteReplaceProps <a name="BaseSiteReplaceProps" id="tech9-cdk-nextjs-standalone.BaseSiteReplaceProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.Initializer"></a>

```typescript
import { BaseSiteReplaceProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.files">files</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.replace">replace</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.search">search</a></code> | <code>string</code> | *No description.* |

---

##### `files`<sup>Required</sup> <a name="files" id="tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.files"></a>
...
##### `replace`<sup>Required</sup> <a name="replace" id="tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.replace"></a>
...
##### `search`<sup>Required</sup> <a name="search" id="tech9-cdk-nextjs-standalone.BaseSiteReplaceProps.property.search"></a>
...
### CreateArchiveArgs <a name="CreateArchiveArgs" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.Initializer"></a>

```typescript
import { CreateArchiveArgs } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.directory">directory</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.zipFileName">zipFileName</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.zipOutDir">zipOutDir</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.fileGlob">fileGlob</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.quiet">quiet</a></code> | <code>boolean</code> | *No description.* |

---

##### `directory`<sup>Required</sup> <a name="directory" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.directory"></a>
...
##### `zipFileName`<sup>Required</sup> <a name="zipFileName" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.zipFileName"></a>
...
##### `zipOutDir`<sup>Required</sup> <a name="zipOutDir" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.zipOutDir"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.compressionLevel"></a>
...
##### `fileGlob`<sup>Optional</sup> <a name="fileGlob" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.fileGlob"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.CreateArchiveArgs.property.quiet"></a>
...
### ImageOptimizationProps <a name="ImageOptimizationProps" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.Initializer"></a>

```typescript
import { ImageOptimizationProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.bucket">bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | The S3 bucket holding application images. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextBuild">nextBuild</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuild">NextjsBuild</a></code> | The `NextjsBuild` instance representing the built Nextjs application. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextLayer">nextLayer</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsLayer">NextjsLayer</a></code> | NextjsLayer - sharp runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.lambdaOptions">lambdaOptions</a></code> | <code>aws-cdk-lib.aws_lambda.FunctionOptions</code> | Override function properties. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.tempBuildDir"></a>
...
##### `bucket`<sup>Required</sup> <a name="bucket" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.bucket"></a>
...
##### `nextBuild`<sup>Required</sup> <a name="nextBuild" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextBuild"></a>
...
##### `nextLayer`<sup>Required</sup> <a name="nextLayer" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.nextLayer"></a>

```typescript
public readonly nextLayer: NextjsLayer;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsLayer">NextjsLayer</a>

NextjsLayer - sharp runtime.

---

##### `lambdaOptions`<sup>Optional</sup> <a name="lambdaOptions" id="tech9-cdk-nextjs-standalone.ImageOptimizationProps.property.lambdaOptions"></a>
...
### NextjsAssetsCachePolicyProps <a name="NextjsAssetsCachePolicyProps" id="tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps.Initializer"></a>

```typescript
import { NextjsAssetsCachePolicyProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps.property.staticMaxAgeDefault">staticMaxAgeDefault</a></code> | <code>aws-cdk-lib.Duration</code> | Cache-control max-age default for S3 static assets. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps.property.staticStaleWhileRevalidateDefault">staticStaleWhileRevalidateDefault</a></code> | <code>aws-cdk-lib.Duration</code> | Cache-control stale-while-revalidate default for S3 static assets. |

---

##### `staticMaxAgeDefault`<sup>Optional</sup> <a name="staticMaxAgeDefault" id="tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps.property.staticMaxAgeDefault"></a>
...
##### `staticStaleWhileRevalidateDefault`<sup>Optional</sup> <a name="staticStaleWhileRevalidateDefault" id="tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps.property.staticStaleWhileRevalidateDefault"></a>
...
### NextjsAssetsDeploymentProps <a name="NextjsAssetsDeploymentProps" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.Initializer"></a>

```typescript
import { NextjsAssetsDeploymentProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.bucket">bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | Properties for the S3 bucket containing the NextJS assets. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nextBuild">nextBuild</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuild">NextjsBuild</a></code> | The `NextjsBuild` instance representing the built Nextjs application. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.cachePolicies">cachePolicies</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps">NextjsAssetsCachePolicyProps</a></code> | Override the default S3 cache policies created internally. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.distribution">distribution</a></code> | <code>aws-cdk-lib.aws_cloudfront.IDistribution</code> | Distribution to invalidate when assets change. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.ephemeralStorageSize">ephemeralStorageSize</a></code> | <code>aws-cdk-lib.Size</code> | ephemeralStorageSize for lambda function which been run by BucketDeployment. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.memoryLimit">memoryLimit</a></code> | <code>number</code> | memoryLimit for lambda function which been run by BucketDeployment. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.prune">prune</a></code> | <code>boolean</code> | Set to true to delete old assets (defaults to false). |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.useEfs">useEfs</a></code> | <code>boolean</code> | In case of useEfs, vpc is required. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.vpc">vpc</a></code> | <code>aws-cdk-lib.aws_ec2.IVpc</code> | In case of useEfs, vpc is required. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.tempBuildDir"></a>
...
##### `bucket`<sup>Required</sup> <a name="bucket" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.bucket"></a>
...
##### `nextBuild`<sup>Required</sup> <a name="nextBuild" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.nextBuild"></a>
...
##### `cachePolicies`<sup>Optional</sup> <a name="cachePolicies" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.cachePolicies"></a>

```typescript
public readonly cachePolicies: NextjsAssetsCachePolicyProps;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsAssetsCachePolicyProps">NextjsAssetsCachePolicyProps</a>

Override the default S3 cache policies created internally.

---

##### `distribution`<sup>Optional</sup> <a name="distribution" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.distribution"></a>
...
##### `ephemeralStorageSize`<sup>Optional</sup> <a name="ephemeralStorageSize" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.ephemeralStorageSize"></a>
...
##### `memoryLimit`<sup>Optional</sup> <a name="memoryLimit" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.memoryLimit"></a>
...
##### `prune`<sup>Optional</sup> <a name="prune" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.prune"></a>
...
##### `useEfs`<sup>Optional</sup> <a name="useEfs" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.useEfs"></a>
...
##### `vpc`<sup>Optional</sup> <a name="vpc" id="tech9-cdk-nextjs-standalone.NextjsAssetsDeploymentProps.property.vpc"></a>
...
### NextjsBaseProps <a name="NextjsBaseProps" id="tech9-cdk-nextjs-standalone.NextjsBaseProps"></a>

Common props shared across NextJS-related CDK constructs.

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.Initializer"></a>

```typescript
import { NextjsBaseProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBaseProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsBaseProps.property.tempBuildDir"></a>
...
### NextjsBuildProps <a name="NextjsBuildProps" id="tech9-cdk-nextjs-standalone.NextjsBuildProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.Initializer"></a>

```typescript
import { NextjsBuildProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuildProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsBuildProps.property.tempBuildDir"></a>
...
### NextjsCachePolicyProps <a name="NextjsCachePolicyProps" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.Initializer"></a>

```typescript
import { NextjsCachePolicyProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.imageCachePolicy">imageCachePolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.ICachePolicy</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.lambdaCachePolicy">lambdaCachePolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.ICachePolicy</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.staticCachePolicy">staticCachePolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.ICachePolicy</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.staticClientMaxAgeDefault">staticClientMaxAgeDefault</a></code> | <code>aws-cdk-lib.Duration</code> | Cache-control max-age default for static assets (/_next/*). |

---

##### `imageCachePolicy`<sup>Optional</sup> <a name="imageCachePolicy" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.imageCachePolicy"></a>
...
##### `lambdaCachePolicy`<sup>Optional</sup> <a name="lambdaCachePolicy" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.lambdaCachePolicy"></a>
...
##### `staticCachePolicy`<sup>Optional</sup> <a name="staticCachePolicy" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.staticCachePolicy"></a>
...
##### `staticClientMaxAgeDefault`<sup>Optional</sup> <a name="staticClientMaxAgeDefault" id="tech9-cdk-nextjs-standalone.NextjsCachePolicyProps.property.staticClientMaxAgeDefault"></a>
...
### NextjsDefaultsProps <a name="NextjsDefaultsProps" id="tech9-cdk-nextjs-standalone.NextjsDefaultsProps"></a>

Defaults for created resources.

Why `any`? see https://github.com/aws/jsii/issues/2901

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsDefaultsProps.Initializer"></a>

```typescript
import { NextjsDefaultsProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.assetDeployment">assetDeployment</a></code> | <code>any</code> | Override static file deployment settings. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.distribution">distribution</a></code> | <code>any</code> | Override CloudFront distribution settings. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.lambda">lambda</a></code> | <code>aws-cdk-lib.aws_lambda.FunctionOptions</code> | Override server lambda function settings. |

---

##### `assetDeployment`<sup>Optional</sup> <a name="assetDeployment" id="tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.assetDeployment"></a>
...
##### `distribution`<sup>Optional</sup> <a name="distribution" id="tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.distribution"></a>
...
##### `lambda`<sup>Optional</sup> <a name="lambda" id="tech9-cdk-nextjs-standalone.NextjsDefaultsProps.property.lambda"></a>
...
### NextjsDistributionCdkProps <a name="NextjsDistributionCdkProps" id="tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps.Initializer"></a>

```typescript
import { NextjsDistributionCdkProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps.property.distribution">distribution</a></code> | <code>aws-cdk-lib.aws_cloudfront.DistributionProps</code> | Pass in a value to override the default settings this construct uses to create the CloudFront `Distribution` internally. |

---

##### `distribution`<sup>Optional</sup> <a name="distribution" id="tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps.property.distribution"></a>
...
### NextjsDistributionProps <a name="NextjsDistributionProps" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.Initializer"></a>

```typescript
import { NextjsDistributionProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.imageOptFunction">imageOptFunction</a></code> | <code>aws-cdk-lib.aws_lambda.IFunction</code> | Lambda function to optimize images. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nextBuild">nextBuild</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuild">NextjsBuild</a></code> | Built NextJS app. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.serverFunction">serverFunction</a></code> | <code>aws-cdk-lib.aws_lambda.IFunction</code> | Lambda function to route all non-static requests to. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.staticAssetsBucket">staticAssetsBucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | Bucket containing static assets. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.cachePolicies">cachePolicies</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps">NextjsCachePolicyProps</a></code> | Override the default CloudFront cache policies created internally. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.cdk">cdk</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps">NextjsDistributionCdkProps</a></code> | Overrides for created CDK resources. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.customDomain">customDomain</a></code> | <code>string \| <a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps">NextjsDomainProps</a></code> | The customDomain for this website. Supports domains that are hosted either on [Route 53](https://aws.amazon.com/route53/) or externally. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.originRequestPolicies">originRequestPolicies</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps">NextjsOriginRequestPolicyProps</a></code> | Override the default CloudFront origin request policies created internally. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.stackPrefix">stackPrefix</a></code> | <code>string</code> | Optional value to prefix the edge function stack It defaults to "Nextjs". |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.stageName">stageName</a></code> | <code>string</code> | Include the name of your deployment stage if present. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.tempBuildDir"></a>
...
##### `imageOptFunction`<sup>Required</sup> <a name="imageOptFunction" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.imageOptFunction"></a>
...
##### `nextBuild`<sup>Required</sup> <a name="nextBuild" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.nextBuild"></a>
...
##### `serverFunction`<sup>Required</sup> <a name="serverFunction" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.serverFunction"></a>
...
##### `staticAssetsBucket`<sup>Required</sup> <a name="staticAssetsBucket" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.staticAssetsBucket"></a>
...
##### `cachePolicies`<sup>Optional</sup> <a name="cachePolicies" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.cachePolicies"></a>

```typescript
public readonly cachePolicies: NextjsCachePolicyProps;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsCachePolicyProps">NextjsCachePolicyProps</a>

Override the default CloudFront cache policies created internally.

---

##### `cdk`<sup>Optional</sup> <a name="cdk" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.cdk"></a>

```typescript
public readonly cdk: NextjsDistributionCdkProps;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsDistributionCdkProps">NextjsDistributionCdkProps</a>

Overrides for created CDK resources.

---

##### `customDomain`<sup>Optional</sup> <a name="customDomain" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.customDomain"></a>

```typescript
public readonly customDomain: string | NextjsDomainProps;
```

- *Type:* string | <a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps">NextjsDomainProps</a>
...
##### `originRequestPolicies`<sup>Optional</sup> <a name="originRequestPolicies" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.originRequestPolicies"></a>

```typescript
public readonly originRequestPolicies: NextjsOriginRequestPolicyProps;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps">NextjsOriginRequestPolicyProps</a>

Override the default CloudFront origin request policies created internally.

---

##### `stackPrefix`<sup>Optional</sup> <a name="stackPrefix" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.stackPrefix"></a>
...
##### `stageName`<sup>Optional</sup> <a name="stageName" id="tech9-cdk-nextjs-standalone.NextjsDistributionProps.property.stageName"></a>
...
### NextjsDomainProps <a name="NextjsDomainProps" id="tech9-cdk-nextjs-standalone.NextjsDomainProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.Initializer"></a>

```typescript
import { NextjsDomainProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.domainName">domainName</a></code> | <code>string</code> | The domain to be assigned to the website URL (ie. domain.com). |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.alternateNames">alternateNames</a></code> | <code>string[]</code> | Specify additional names that should route to the Cloudfront Distribution. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.certificate">certificate</a></code> | <code>aws-cdk-lib.aws_certificatemanager.ICertificate</code> | Import the certificate for the domain. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.domainAlias">domainAlias</a></code> | <code>string</code> | An alternative domain to be assigned to the website URL. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.hostedZone">hostedZone</a></code> | <code>aws-cdk-lib.aws_route53.IHostedZone</code> | Import the underlying Route 53 hosted zone. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsDomainProps.property.isExternalDomain">isExternalDomain</a></code> | <code>boolean</code> | Set this option if the domain is not hosted on Amazon Route 53. |

---

##### `domainName`<sup>Required</sup> <a name="domainName" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.domainName"></a>
...
##### `alternateNames`<sup>Optional</sup> <a name="alternateNames" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.alternateNames"></a>
...
##### `certificate`<sup>Optional</sup> <a name="certificate" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.certificate"></a>
...
##### `domainAlias`<sup>Optional</sup> <a name="domainAlias" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.domainAlias"></a>
...
##### `hostedZone`<sup>Optional</sup> <a name="hostedZone" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.hostedZone"></a>
...
##### `isExternalDomain`<sup>Optional</sup> <a name="isExternalDomain" id="tech9-cdk-nextjs-standalone.NextjsDomainProps.property.isExternalDomain"></a>
...
### NextjsLambdaProps <a name="NextjsLambdaProps" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.Initializer"></a>

```typescript
import { NextjsLambdaProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nextBuild">nextBuild</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuild">NextjsBuild</a></code> | Built nextJS application. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.lambda">lambda</a></code> | <code>aws-cdk-lib.aws_lambda.FunctionOptions</code> | Override function properties. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.tempBuildDir"></a>
...
##### `nextBuild`<sup>Required</sup> <a name="nextBuild" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.nextBuild"></a>
...
##### `lambda`<sup>Optional</sup> <a name="lambda" id="tech9-cdk-nextjs-standalone.NextjsLambdaProps.property.lambda"></a>
...
### NextjsLayerProps <a name="NextjsLayerProps" id="tech9-cdk-nextjs-standalone.NextjsLayerProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsLayerProps.Initializer"></a>

```typescript
import { NextjsLayerProps } from 'tech9-cdk-nextjs-standalone'

const nextjsLayerProps: NextjsLayerProps = { ... }
```


### NextjsOriginRequestPolicyProps <a name="NextjsOriginRequestPolicyProps" id="tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.Initializer"></a>

```typescript
import { NextjsOriginRequestPolicyProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.fallbackOriginRequestPolicy">fallbackOriginRequestPolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.IOriginRequestPolicy</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.imageOptimizationOriginRequestPolicy">imageOptimizationOriginRequestPolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.IOriginRequestPolicy</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.lambdaOriginRequestPolicy">lambdaOriginRequestPolicy</a></code> | <code>aws-cdk-lib.aws_cloudfront.IOriginRequestPolicy</code> | *No description.* |

---

##### `fallbackOriginRequestPolicy`<sup>Optional</sup> <a name="fallbackOriginRequestPolicy" id="tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.fallbackOriginRequestPolicy"></a>
...
##### `imageOptimizationOriginRequestPolicy`<sup>Optional</sup> <a name="imageOptimizationOriginRequestPolicy" id="tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.imageOptimizationOriginRequestPolicy"></a>
...
##### `lambdaOriginRequestPolicy`<sup>Optional</sup> <a name="lambdaOriginRequestPolicy" id="tech9-cdk-nextjs-standalone.NextjsOriginRequestPolicyProps.property.lambdaOriginRequestPolicy"></a>
...
### NextjsProps <a name="NextjsProps" id="tech9-cdk-nextjs-standalone.NextjsProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsProps.Initializer"></a>

```typescript
import { NextjsProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.defaults">defaults</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsDefaultsProps">NextjsDefaultsProps</a></code> | Allows you to override defaults for the resources created by this construct. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsProps.property.imageOptimizationBucket">imageOptimizationBucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | Optional S3 Bucket to use, defaults to assets bucket. |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsProps.property.tempBuildDir"></a>
...
##### `defaults`<sup>Optional</sup> <a name="defaults" id="tech9-cdk-nextjs-standalone.NextjsProps.property.defaults"></a>

```typescript
public readonly defaults: NextjsDefaultsProps;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.NextjsDefaultsProps">NextjsDefaultsProps</a>

Allows you to override defaults for the resources created by this construct.

---

##### `imageOptimizationBucket`<sup>Optional</sup> <a name="imageOptimizationBucket" id="tech9-cdk-nextjs-standalone.NextjsProps.property.imageOptimizationBucket"></a>
...
### NextjsS3EnvRewriterProps <a name="NextjsS3EnvRewriterProps" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.Initializer"></a>

```typescript
import { NextjsS3EnvRewriterProps } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nextjsPath">nextjsPath</a></code> | <code>string</code> | Relative path to the directory where the NextJS project is located. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.buildPath">buildPath</a></code> | <code>string</code> | The directory to execute `npm run build` from. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.compressionLevel">compressionLevel</a></code> | <code>number</code> | 0 - no compression, fastest 9 - maximum compression, slowest. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.environment">environment</a></code> | <code>{[ key: string ]: string}</code> | Custom environment variables to pass to the NextJS build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.isPlaceholder">isPlaceholder</a></code> | <code>boolean</code> | Skip building app and deploy a placeholder. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nodeEnv">nodeEnv</a></code> | <code>string</code> | Optional value for NODE_ENV during build and runtime. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.packageManager">packageManager</a></code> | <code>string</code> | Optional value used to install NextJS node dependencies. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.projectRoot">projectRoot</a></code> | <code>string</code> | Root of your project, if different from `nextjsPath`. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.quiet">quiet</a></code> | <code>boolean</code> | Less build output. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.tempBuildDir">tempBuildDir</a></code> | <code>string</code> | Directory to store temporary build files in. |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.replacementConfig">replacementConfig</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig">RewriteReplacementsConfig</a></code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.s3Bucket">s3Bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.s3keys">s3keys</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.cloudfrontDistributionId">cloudfrontDistributionId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.debug">debug</a></code> | <code>boolean</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nextBuild">nextBuild</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.NextjsBuild">NextjsBuild</a></code> | *No description.* |

---

##### `nextjsPath`<sup>Required</sup> <a name="nextjsPath" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nextjsPath"></a>
...
##### `buildPath`<sup>Optional</sup> <a name="buildPath" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.buildPath"></a>
...
##### `compressionLevel`<sup>Optional</sup> <a name="compressionLevel" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.compressionLevel"></a>
...
##### `environment`<sup>Optional</sup> <a name="environment" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.environment"></a>
...
##### `isPlaceholder`<sup>Optional</sup> <a name="isPlaceholder" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.isPlaceholder"></a>
...
##### `nodeEnv`<sup>Optional</sup> <a name="nodeEnv" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nodeEnv"></a>
...
##### `packageManager`<sup>Optional</sup> <a name="packageManager" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.packageManager"></a>
...
##### `projectRoot`<sup>Optional</sup> <a name="projectRoot" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.projectRoot"></a>
...
##### `quiet`<sup>Optional</sup> <a name="quiet" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.quiet"></a>
...
##### `tempBuildDir`<sup>Optional</sup> <a name="tempBuildDir" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.tempBuildDir"></a>
...
##### `replacementConfig`<sup>Required</sup> <a name="replacementConfig" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.replacementConfig"></a>

```typescript
public readonly replacementConfig: RewriteReplacementsConfig;
```

- *Type:* <a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig">RewriteReplacementsConfig</a>

---

##### `s3Bucket`<sup>Required</sup> <a name="s3Bucket" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.s3Bucket"></a>
...
##### `s3keys`<sup>Required</sup> <a name="s3keys" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.s3keys"></a>
...
##### `cloudfrontDistributionId`<sup>Optional</sup> <a name="cloudfrontDistributionId" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.cloudfrontDistributionId"></a>
...
##### `debug`<sup>Optional</sup> <a name="debug" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.debug"></a>
...
##### `nextBuild`<sup>Required</sup> <a name="nextBuild" id="tech9-cdk-nextjs-standalone.NextjsS3EnvRewriterProps.property.nextBuild"></a>
...
### RewriteReplacementsConfig <a name="RewriteReplacementsConfig" id="tech9-cdk-nextjs-standalone.RewriteReplacementsConfig"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.Initializer"></a>

```typescript
import { RewriteReplacementsConfig } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.env">env</a></code> | <code>{[ key: string ]: string}</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.jsonS3Bucket">jsonS3Bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.jsonS3Key">jsonS3Key</a></code> | <code>string</code> | *No description.* |

---

##### `env`<sup>Optional</sup> <a name="env" id="tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.env"></a>
...
##### `jsonS3Bucket`<sup>Optional</sup> <a name="jsonS3Bucket" id="tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.jsonS3Bucket"></a>
...
##### `jsonS3Key`<sup>Optional</sup> <a name="jsonS3Key" id="tech9-cdk-nextjs-standalone.RewriteReplacementsConfig.property.jsonS3Key"></a>
...
### RewriterParams <a name="RewriterParams" id="tech9-cdk-nextjs-standalone.RewriterParams"></a>

#### Initializer <a name="Initializer" id="tech9-cdk-nextjs-standalone.RewriterParams.Initializer"></a>

```typescript
import { RewriterParams } from 'tech9-cdk-nextjs-standalone'
...
| **Name** | **Type** | **Description** |
| --- | --- | --- |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriterParams.property.replacementConfig">replacementConfig</a></code> | <code><a href="#tech9-cdk-nextjs-standalone.RewriteReplacementsConfig">RewriteReplacementsConfig</a></code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriterParams.property.s3Bucket">s3Bucket</a></code> | <code>aws-cdk-lib.aws_s3.IBucket</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriterParams.property.s3keys">s3keys</a></code> | <code>string[]</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriterParams.property.cloudfrontDistributionId">cloudfrontDistributionId</a></code> | <code>string</code> | *No description.* |
| <code><a href="#tech9-cdk-nextjs-standalone.RewriterParams.property.debug">debug</a></code> | <code>boolean</code> | *No description.* |

---

##### `replacementConfig`<sup>Required</sup> <a name="replacementConfig" id="tech9-cdk-nextjs-standalone.RewriterParams.property.replacementConfig"></a>
...
##### `s3Bucket`<sup>Required</sup> <a name="s3Bucket" id="tech9-cdk-nextjs-standalone.RewriterParams.property.s3Bucket"></a>
...
##### `s3keys`<sup>Required</sup> <a name="s3keys" id="tech9-cdk-nextjs-standalone.RewriterParams.property.s3keys"></a>
...
##### `cloudfrontDistributionId`<sup>Optional</sup> <a name="cloudfrontDistributionId" id="tech9-cdk-nextjs-standalone.RewriterParams.property.cloudfrontDistributionId"></a>
...
##### `debug`<sup>Optional</sup> <a name="debug" id="tech9-cdk-nextjs-standalone.RewriterParams.property.debug"></a>
